	...
	render() {
		return (
			<svg className={this.props.className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 157.89 282.11">
				...
				<g>
					<polygon className={cx('poly_end', {animate_end: this.state.isAnimating})} points="109.78 37.88 109.78 0 157.89 24.06 109.78 37.88"/>
					...
					<polygon className={cx('poly_end', {animate_end: this.state.isAnimating})} points="48.09 282.11 0 257.58 48.09 243.92 48.09 282.11"/>
				</g>
			</svg>
		);
	}
